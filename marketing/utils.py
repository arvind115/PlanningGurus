...
MAILCHIMP_API_KEY = getattr(settings, "MAILCHIMP_API_KEY","57c85b21860398d8517c11bf27f2af5b-us20")
MAILCHIMP_DATA_CENTER = getattr(settings, "MAILCHIMP_DATA_CENTER", "us20")
...
class Mailchimp(object):
    ...
    def change_subcription_status(self, email, status='unsubscribed'):
        ...
        data = {
            ...
            "email_address":email #(don't)delete this line
            #should work only with email-hash itself. look deeper into the documentation
        }
    ...
    def add_email(self, email):
        ...
        print('DATA center:',MAILCHIMP_DATA_CENTER)
        print('API key:',MAILCHIMP_API_KEY)
